                  ...
                  <div className="col-md-3">
                   ...
                   <div className="col-md-9 mx-auto" style={{height: "800px"}}>   
                     <div className="row" style={{marginTop : "60px" , overflow : "hidden"}}>        
                      <div id="my-div">            
                       <iframe width="900" height="600" src={`https://mentor.tradetipsapp.com:8080/neww?uname=${this.state.storageData.uname}&uid=${this.state.storageData.uid}`} id="my-iframe" scrolling="yes"></iframe>
                     </div>
                     </div>
                    </div>
              </div>
